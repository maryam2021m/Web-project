...
class InventoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('staff.inventories.table'))->with('success', 'موجودی با موفقیت اضافه شد!');
    }
    ...
    public function update(Inventory $inventory, Request $request)
    {
        ...
        return redirect(route('staff.inventories.table'))->with('success', 'داده ها با موفقیت به روز شد!');
    }
