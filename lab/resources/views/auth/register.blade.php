            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="#" class="app-brand-link gap-2 d-flex justify-content-center">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">(عج) آزمایشگاه ولی عصر</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">ثبت نام در سیستم جامع آز کشور 🚀</h4>

              <form method="POST" class="mb-3" action="{{ route('register') }}">
                @csrf
                <div class="mb-3">
                  <label for="username" class="form-label">کد ملی</label>
                  <input id="reg_number" type="text" placeholder="عدد 10 رقمی" class="form-control @error('reg_number') is-invalid @enderror" name="reg_number" value="{{ old('reg_number') }}" required autocomplete="reg_number" autofocus>
                  @error('reg_number')
                ...
                <div class="mb-3">
                  ...
                  <input id="name" type="text" placeholder="علی واقفی" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name">
                  @error('name')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
                ...
                <div class="mb-3">
                  ...
                  <input id="email" placeholder="test1401@gmail.com" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                  @error('email')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
