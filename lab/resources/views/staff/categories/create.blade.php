...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4 text-white">اضافه کردن دسته</h4>
        ...
        <div class="card pb-2 bg-dark shadow">
          <div class="card-body">
            <form action="{{ route('staff.categories.create') }}" method="POST">
                @csrf
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label text-white" for="name">نام دسته</label>
                    <div class="col-sm-10">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalCenterTitle">آیا واقعا قصد حذف دارید ؟</h5>
          </div>
