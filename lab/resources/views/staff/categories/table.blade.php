...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4 text-white">جدول دسته بندی</h4>
        
        <!-- Basic Bootstrap Table -->
        <div class="card pb-2 bg-dark shadow">
          <x-alert></x-alert>
          <div class="card-header">
            <a href="{{ route('staff.categories.create') }}" class="btn btn-primary btn-lg text-white"> <i class="bx bx-plus"></i>ساخت دسته بندی</a>
          </div>
