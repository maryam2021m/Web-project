...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4 text-white">ویرایش</h4>
        ...
        <div class="card pb-2 bg-dark shadow">
          <div class="card-body">
            <form action="{{ route('staff.inventories.edit', $inventory) }}" method="POST">
                ...
                @method('PUT')
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label text-white" for="item-code">ردیف</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-10">
                    <select class="form-select bg-dark text-white" name="condition" id="condition" aria-label="Default select example">
                      ...
                      <option value="bad" {{ $inventory->condition == 'bad' ? 'selected' : '' }} >bad</option>
                    </select>
                    @error('condition')
                        <span class="text-danger" role="alert">
                          <p class="m-0 mt-2">{{ $message }}</p>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalCenterTitle">مطمئن هستید؟</h5>
          </div>
