            ...
            <div class="col-lg-8 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">خوش آمدید {{ $name }}! 🎉</h5>
                                <p class="mb-4">
                                    <span class="fw-bold">مثبت بمانید!!. آینده متعلق به شماست که آن را از امروز آماده کرده اید
                                </p>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 order-1">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                        {{-- <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-3 text-center text-warning">امانت</h5>
                                <h1 class="card-title mb-3 text-center text-warning">{{ $loans_total }}</h1>
                                <p class="fw-semibold mb-0 text-center text-warning">بار</p>
                            </div>
                        </div> --}}
                    </div>
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-3 text-center text-primary">ویزیت</h5>
                                <h1 class="card-title mb-3 text-center text-primary">{{ $guestbook_total }}</h1>
                                <p class="fw-semibold mb-0 text-center text-primary">بار</p>
                            </div>
                        </div>
                    </div>
                </div>
